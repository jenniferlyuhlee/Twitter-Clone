...
def users_show(user_id):
    ...
    ### INSTEAD USED JINJA SORT ON user.messages ###
...
def profile():
    ...
    if form.validate_on_submit():
        if User.authenticate(g.user.username, form.password.data):
            ...
            db.session.commit()
            flash(f"{g.user.username}'s profile was edited.", "info")
